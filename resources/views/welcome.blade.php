        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            ...
            <div class="w-full max-w-2xl mx-auto p-6 lg:p-8">
                <div class="flex justify-center">
                    <!-- Logo -->
                     <a href="https://www.kaosport.com/" target="_blank">
                ...
                <div class="mt-6">
                    <div class="grid grid-cols-1 md:grid-cols-1 gap-6 lg:gap-8">
                        ...
                        <div class="flex flex-col w-full scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex focus:outline focus:outline-2 focus:outline-red-500">
